...
public class RestaurantActivity extends AppCompatActivity implements PermissionsListener, OnMapReadyCallback {
    ...
    public void onMapReady(@NonNull @NotNull MapboxMap mapboxMap) {
        RestaurantActivity.this.mapboxMap = mapboxMap;
        mapboxMap.setStyle(Style.MAPBOX_STREETS, new Style.OnStyleLoaded() {
            ...
            public void onStyleLoaded(@NonNull @NotNull Style style) {
                ...
                Toast.makeText(RestaurantActivity.this, "move_map_instruction", Toast.LENGTH_SHORT).show();
                ...
                originMarker = new ImageView(RestaurantActivity.this);
                ...
                selectOriginLocationButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if (originMarker.getVisibility() == View.VISIBLE) {
                            ...
                            selectOriginLocationButton.setBackgroundColor(
                                    ContextCompat.getColor(RestaurantActivity.this, R.color.purple_200));
                            ...
                            getReverseLocation(Point.fromLngLat(mapTargetLatLng.getLongitude(),mapTargetLatLng.getLatitude()));
...
// Add the marker image to map
        loadedMapStyle.addImage("dropped-icon-image", AppCompatResources.getDrawable(RestaurantActivity.this, R.drawable.blue_marker));
...
// reset the GeoJSON source for the route LineLayer source
            ...
            public void onFailure(Call<DirectionsResponse> call, Throwable throwable) {
                ...
                Toast.makeText(RestaurantActivity.this, "Error: " + throwable.getMessage(),
...
// Set the component's camera mode
    ...
    private void getReverseLocation(Point point){
                ...
                new com.android.volley.Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            originEdt.setText(address);
                            Toast.makeText(RestaurantActivity.this,address,Toast.LENGTH_LONG).show();
