                ...
                selectOriginLocationButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        getReverseAddress(Point.fromLngLat(mapTargetLatLng.getLongitude(), mapTargetLatLng.getLatitude()), new VolleyCallback() {
                            @Override
                            public void onSuccess(String address, String cityName) {

                                if (cityName.equals("سنندج")) {
                                    if (a == 1) {
                                        ...
                                        if (destination != null) {
                                            ...
                                            if (originTitle != "") {
                                                ...
                                                bundle.putString(EXTRA_KEY_DESTINATION_LAT, String.valueOf(destination.latitude()));
                                                bundle.putString(EXTRA_KEY_DESTINATION_LON, String.valueOf(destination.longitude()));
                                                bundle.putString(EXTRA_KEY_ORIGIN_TITLE, originTitle);
                                                bundle.putString(EXTRA_KEY_DESTINATION_TITLE, destinationTitle);
                                                bundle.putInt(EXTRA_KEY_TYPE, TYPE_NORMAL_DELIVERY);
                                    ...
                                    Toast.makeText(DeliveryActivity.this, getString(R.string.city_not_available), Toast.LENGTH_SHORT).show();
                                }
                        ...
                        public void onSuccess(String address, String cityName) {
                            ...
                            if (cityName.equals("سنندج")) {
                                ...
                                if (b == 1) {
                                    ...
                                    selectDestinationLocationButton.setText(getString(R.string.remove_destination));
                ...
                new com.android.volley.Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            callback.onSuccess(address, cityName);
