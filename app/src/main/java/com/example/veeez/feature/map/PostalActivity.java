...
import com.example.veeez.feature.map.order.postal.PostalShippingActivity;
import com.example.veeez.feature.map.search.SearchActivity;
...
public class PostalActivity extends AppCompatActivity implements PermissionsListener, OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        originEdt.setOnClickListener(view->{
    ...
    private void initViews() {
        mapView = findViewById(R.id.restaurant_map_view);
        originEdt = findViewById(R.id.restaurant_origin_search_edt);
        findMyLocationBtn = findViewById(R.id.restaurant_find_my_location_btn);

    }

    @Override
    public void onMapReady(@NonNull @NotNull MapboxMap mapboxMap) {
        PostalActivity.this.mapboxMap = mapboxMap;
        mapboxMap.setStyle(Style.MAPBOX_STREETS, new Style.OnStyleLoaded() {
            ...
            public void onStyleLoaded(@NonNull @NotNull Style style) {
                ...
                //Toast.makeText(PostalActivity.this, "move_map_instruction", Toast.LENGTH_SHORT).show();


                //origin = Point.fromLngLat(51.3895987403, 35.7183036633);
                ...
                originMarker = new ImageView(PostalActivity.this);
                ...
                selectOriginLocationButton = findViewById(R.id.confirm_origin_btn);
                selectOriginLocationButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        if (originMarker.getVisibility() == View.VISIBLE) {
                            ...
                            getReverseLocation(Point.fromLngLat(mapTargetLatLng.getLongitude(), mapTargetLatLng.getLatitude()), new VolleyCallback() {
                                @Override
...
// Add the marker image to map
        loadedMapStyle.addImage("dropped-icon-image", AppCompatResources.getDrawable(PostalActivity.this, R.drawable.blue_marker));
...
// reset the GeoJSON source for the route LineLayer source
            ...
            public void onFailure(Call<DirectionsResponse> call, Throwable throwable) {
                ...
                Toast.makeText(PostalActivity.this, "Error: " + throwable.getMessage(),
...
// Set the component's camera mode
    ...
    private void getReverseLocation(Point point,VolleyCallback volleyCallback){
                ...
                new com.android.volley.Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            volleyCallback.onSuccess(address);
                           // Toast.makeText(PostalActivity.this,address,Toast.LENGTH_LONG).show();
